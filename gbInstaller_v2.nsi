...
SectionGroup "Dependencies"
 Section "Java 21"
  ...
  IfFileExists '$PROGRAMFILES64\Eclipse Adoptium\jdk-21.0.5.11-hotspot\bin\javaw.exe' skipTemurin 0
	...
	inetc::get /CAPTION "Downloading Java Installer Package" "https://github.com/adoptium/temurin21-binaries/releases/download/jdk-21.0.5%2B11/OpenJDK21U-jdk_x64_windows_hotspot_21.0.5_11.msi" "$TEMP\gbsInstaller\OpenJDK21U-jdk_x64_windows_hotspot_21.0.5_11.msi" /end
    ExecWait '"msiexec" /i "$TEMP\gbsInstaller\OpenJDK21U-jdk_x64_windows_hotspot_21.0.5_11.msi" ADDLOCAL=FeatureMain,FeatureEnvironment,FeatureJarFileRunWith,FeatureJavaHome,FeatureOracleJavaSoft INSTALLDIR="C:\Program Files\Eclipse Adoptium\jdk-21.0.5.11-hotspot\" /qb+!'
    Delete $TEMP\gbsInstaller\OpenJDK21U-jdk_x64_windows_hotspot_21.0.5_11.msi
...
Section "-Config"
 ...
 # File files\mcFiles\core\config\respackopts\_respackopts.conf
  ...
  nsJSON::Set "profiles" "golden-bones-seasonV" "javaDir" /value '"C:\\Program Files\\Eclipse Adoptium\\jdk-21.0.5.11-hotspot\\bin\\javaw.exe"'
