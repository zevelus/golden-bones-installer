...
SectionGroup "Dependencies"
 Section "Java 21"
  ...
  IfFileExists '$PROGRAMFILES64\Eclipse Adoptium\jdk-21.0.3.9-hotspot\bin\javaw.exe' skipTemurin 0
    DetailPrint "Latest Temurin 21 version not found."
    MessageBox MB_ICONINFORMATION|MB_OKCANCEL|MB_DEFBUTTON1 "Java 21 was not detected!$\nThis is required for running any Minecraft mods.$\n$\n$\tEclipse Temurin 21 is one of the best Java 21 builds.$\n$\tClick Okay to install it automatically.$\n$\n(Click Okay unless you are a techno-wiz that's certain you already have Java 21 installed)" /SD IDOK IDCANCEL skipTemurin
    DetailPrint "Installing Temurin 21..."
	SetOutPath $TEMP\gbsInstaller
	File files\dependencies\OpenJDK21U-jdk_x64_windows_hotspot_21.0.3_9.msi
    ExecWait '"msiexec" /i "$TEMP\gbsInstaller\OpenJDK21U-jdk_x64_windows_hotspot_21.0.3_9.msi" ADDLOCAL=FeatureMain,FeatureEnvironment,FeatureJarFileRunWith,FeatureJavaHome,FeatureOracleJavaSoft INSTALLDIR="C:\Program Files\Eclipse Adoptium\jdk-21.0.3.9-hotspot\" /qb+!'
    Delete $TEMP\gbsInstaller\OpenJDK21U-jdk_x64_windows_hotspot_21.0.3_9.msi
 ...
 Section "Fabric"
  ...
  IfFileExists '$APPDATA\.minecraft\versions\fabric-loader-0.15.11-1.20.6\fabric-loader-0.15.11-1.20.6.json' skipFabric 0
...
Section "-Config"
  ...
  nsJSON::Set "profiles" "golden-bones-season5" "javaDir" /value '"C:\\Program Files\\Eclipse Adoptium\\jdk-21.0.3.9-hotspot\\bin\\javaw.exe"'
